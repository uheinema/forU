...
public class Ttf {
  ...
  static
    public PGraphics me; // set this or a shack...

  static final public HashMap<String, Ttf> fontCache=
    new HashMap<String, Ttf>();
  static String beatNick;

  static public Ttf loadFont(String nick, String filename) {
  ...
  public class defSc implements ShapeCreator {    
      ...
      while ((flag & MORE_COMPONENTS)!=0) {
        ...
        if (simpleGlyph!=null) { // always..
          ...
          for (int i = 0; i < simpleGlyph.points.length; i++) {
            ...
            x = component.a * x + component.b * y + component.e;
            y = component.c * x + component.d * y -  component.f;
  ...
  public PVector text(String t) {

    float x=0; // blaleeanmingapetcpp
    float y=0;
    float mx=0;
    float my=0;
    shacka().createShape();
