...
public String[] loadResStrings(String path)
{
  ...
  { 
    println("Oops Cant read from "+path);
  } 
  return null;
}
...
private boolean copyFileAsset(String path) { 
  Activity a=getActivity();
  File file = 
    new File(SD(
    //a.getExternalFilesDir(null),
